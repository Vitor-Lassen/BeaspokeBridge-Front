<template>
  <ds-container >
    ...
    <p>
      Acreditamos que a colaboração é essencial para oferecer aos nossos alunos experiências
      educacionais completas e de alta qualidade. Por isso, estabelecemos parcerias estratégicas com
