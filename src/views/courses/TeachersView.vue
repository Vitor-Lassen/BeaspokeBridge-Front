  ...
  <ds-container >
    <div class="d-flex">
      <div>
        ...
        <p>
          From our own experience, we know how difficult the teaching profession is. That is why we
          want to invite you to a professional community for which education is a lifelong
          enrichment. With us you will find new knowledge, skills and encouragement for further
          pedagogical work. Like dozens of your teaching colleagues so far.
        </p>
      </div>
      <v-img src="icones/one white teacher.png" min-width="200"> </v-img>
    </div>
  ...
  <ds-container  >
    ...
    <ul class="base-list ml-16">
      <li>
        ...
        <p>
          Equip yourself with the tools and knowledge to address the real-life challenges your
          students face today. Learn to guide them effectively by incorporating current, relevant
          topics into your lessons using cutting-edge educational materials, digital tools, and
          resources.
        </p>
      </li>
      <li>
        <b> Experience Modern, Interactive Teaching</b><br />

        <p>
          Dive into a world of dynamic, experiential teaching methods. These courses are designed to
          rekindle your creativity, helping you engage students in meaningful ways and eliminate
          monotony from your classroom.
        </p>
      </li>
      <li>
        <b> Inspire and Transform</b><br />

        <p>
          Beyond professional growth, our courses encourage personal development. Led by inspiring
          mentors and featuring a thoughtfully designed leisure program, you'll gain space for
          self-reflection and leave feeling empowered in a supportive and empathetic environment.
        </p>
      </li>
    </ul>
