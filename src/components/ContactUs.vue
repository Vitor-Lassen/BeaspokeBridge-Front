<template>
  <v-form class="pa-4">
    ...
    <v-textarea v-model="message" :label="$t('contact-us.form.service')" rows="3" required></v-textarea>
    <v-btn color="secondary" @click="submit"> {{$t('contact-us.form.btn-send')}} </v-btn>
